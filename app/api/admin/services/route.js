...
async function getAllServices(request) {
    try {
        ...
        await ServiceController.getAllServices(mockReq, mockRes);
...
async function createService(request) {
    try {
        ...
        await ServiceController.createService(mockReq, mockRes);
        return Response.json(responseData, { status: responseStatus });
...
export const GET = withAuth(getAllServices);
