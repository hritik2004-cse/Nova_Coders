...
import Logo from './utility/Logo'; // Assuming your Logo component is in the same folder
import Social from './Utility/Social'; // Assuming your Social component is in the same folder
